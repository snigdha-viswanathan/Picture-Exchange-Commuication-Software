...
public class RecordVideo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopRecordingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("video_url", destinationFile2.getAbsolutePath());
    ...
    private void startPreview()
    {
        ...
        destinationFile2 = new File(appFolder, "video"+CommonUtils.getUniqueRandomID()+".mp4");
        videoRecorder = new VideoRecorder(getApplicationContext(), destinationFile2, RecordSettings.GetDefault(this));
