...
public class RecordVideoSampleActivity extends AppCompatActivity {
    ...
    private void startPreview()
    {
        ...
        destinationFile = new File(appFolder, "video"+CommonUtils.getUniqueRandomID()+".mp4");
        videoRecorder = new VideoRecorder(getApplicationContext(), destinationFile, RecordSettings.GetDefault(this));
